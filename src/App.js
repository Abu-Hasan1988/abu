    ...
    async function fetchData() {
      ...
      try {
        const [cartResponse, favoritesResponse, itemsResponse] = await Promise.all([
          axios.get('https://6418af2575be53f451e53677.mockapi.io/cart'), 
          axios.get('https://6437dbe5894c9029e8c8093d.mockapi.io/favorites') ,
          axios.get('https://6418af2575be53f451e53677.mockapi.io/items'),
        ]);
 ...
 const onAddToCart = async (obj) => {
   ...
   try { 
    ...
    if(findItem ) {
      ...
      await axios.delete(`https://6418af2575be53f451e53677.mockapi.io/cart/${findItem.id}`); 
  
 } else {
  setCartItems((prev)=>[...prev, obj]);
  const {data} = await axios.post('https://6418af2575be53f451e53677.mockapi.io/cart', obj);
